...
export function AddNewNonVeg(){
    ...
    const {values,handleChange,handleSubmit,errors,touched} = useFormik(
        {
            ...
            onSubmit: (values) =>{
                ...
                async function addNewMenu() {
                    return await axios.post(`${API}/addMenu/addNonVegMenu`,obj);
                }
    ...
    return(
        <form className="add-new-recipe w-50 m-auto mt-5 d-flex flex-column gap-3" onSubmit={handleSubmit}>
            <p> Enter the name, description and image URL of new non-veg pizza in the below form</p>
